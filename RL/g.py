    ...
    for vertex in range(len(shortestPaths)):
        ...
        if grf["grfProperties"]["rwdValuation"] == 0:
            ...
            for nbr in nbrs:
                for tupInNbr in shortestPaths[nbr]:
                    ...
                    if (tupInNbr[0] + 1 == pathLength and tupInNbr[1] == rwd and tupInNbr[2] >= rwdOverLen):
                        if nbr == vertex-grf["grfProperties"]["width"]:
                            ...
                            grfPath += "."
                            break
                # maxTupByRwdForNbr = sorted(shortestPaths[nbr], key=lambda x: x[1]+1/x[0], reverse=True)[0]
                # if maxTupByRwdForNbr[0]+1 == pathLength and maxTupByRwdForNbr[1] == rwd:
                #     if nbr == vertex-grf["grfProperties"]["width"]:
                #         grfPath += "U"
                #     elif nbr == vertex-1:
                #         grfPath += "L"
                ...
                #         grfPath += "."
        # for nbr in nbrs:
        #     if shortestPaths[nbr][0]+1 == pathLength:
        #         if grf["grfProperties"]["rwdValuation"] == 0 and shortestPaths[nbr][1] != shortestPaths[vertex][1]: continue
        #         if grf["grfProperties"]["rwdValuation"] == 1 and shortestPaths[nbr][1] < shortestPaths[vertex][1]: continue
        #         if nbr == vertex-grf["grfProperties"]["width"]:
        #             grfPath += "U"
        #         elif nbr == vertex-1:
        #             grfPath += "L"
        ...
        # else:
        #     for nbr in nbrs:
        #         if shortestPaths[nbr][1] >= shortestPaths[vertex][1]:
        #             if nbr == vertex-grf["grfProperties"]["width"]:
        #                 grfPath += "U"
        #             elif nbr == vertex-1:
        #                 grfPath += "L"
