    ...
    for arg in lstArgs:
        if arg[0] == "G":
            ...
            if arg[1] in "!+*~@": 
                mngmnt = arg[1]
                start = 2
            if "N" in arg or "E" in arg or "S" in arg or "W" in arg:
                vscls = ""
...
def grfVProps(graph, v): # COMPLETE
    if len(graph["edges"]) > v: return graph["edges"][v][1]
    return {}
