...
def makeMove(board, move, validMoves, token):
    board = board[:move] + token.upper() + board[move+1:]
...
def main():
    global args
    if not args: args = "4445372921434241491340341420_5_7235059564858576051_6122231_4153033392624321716_852533847191118_91025_3_2_1_06154-146-162".split()
    ...
    while i < len(moves):
        ...
        else: token = printPossibleMoves(board, token)
        i += 1
