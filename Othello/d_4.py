...
def quickMove(board, token):
    ...
    if (u:=corners.intersection(set(validMoves.keys()))): return u.pop()
    if (u:=walls.intersection(set(validMoves.keys()))): return u.pop()
    ...
    bestScore = originalNumOfOppositeMoves - len(findPossibleMoves(makeMove(board, bestMove, validMoves, token), getOppositeToken(token)))
...
def main():
    global args
    if not args: args = "..........o..x.....ooo.....xox.....ox.....o..x.................. 343022261754141538434452_31211393725_731_51850_8334151_96058_259 16 1 48 40 6 4 63 46 49-155-146".split()
