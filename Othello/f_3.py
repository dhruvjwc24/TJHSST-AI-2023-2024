...
def extractFromArgs(args):
    board, token, suppress, moves, holeLimit, verbose, noArgs = '', '', False, [], 13, False, False
...
def main():
    ...
    # if not args: args = "1918172045343729125421_4111041464413_125_5_9_0_638426240166353323026334348_8245251".split()
