...
def main():
    global args
    if not args: args = "26 34 43 18 29 51 9 30 22 37 42 25 44 53 59 49 45 11 16 0 2 38 20 58 52 19 23 13 6 60 10 54 41 17 24 33 61 3 4 15 14 21 46 7 48 31 55 50 47 62 57 8 32 40 39 56 12 63 -1 5 -1 1".split()
